<x-app-layout>
    @push('css')
        <link rel="stylesheet" href="{{ asset('vendor/jQuery/dataTables.dataTables.css') }}">
        {{-- <link rel="stylesheet" href="{{ asset('vendor/dataTables/css/dataTables.tailwindcss.css') }}"> --}}
    @endpush
                                        ...
                                        <thead>
                                            <tr>
                                                <th scope="col" width="24"
                                                    ...
                                                    No</th>
                                                <th scope="col"
                                                    class="flex-1 px-6 py-3 text-start text-xs font-medium uppercase text-gray-500 dark:text-neutral-500">
                                                    Title</th>
                                                <th scope="col"
                                                    class="px-6 py-3 text-start text-xs font-medium uppercase text-gray-500 dark:text-neutral-500">
                                                    Status</th>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($posts as $post)
                                                <tr
                                                    ...
                                                    <td
                                                        class="flex flex-col items-start gap-1 px-6 py-4 text-start text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                        {{ $post->title }}
                                                        <small class="text-xs text-orange-500">by:
                                                            {{ $post->user->name }}</small>
                                                    </td>
                                                    <td
                                                        class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                        {{ \Illuminate\Support\Str::title($post->status) }}</td>
                                                    <td
    ...
    @push('js')
        ...
        {{-- <script src="{{ asset('vendor/dataTables/js/dataTables.tailwindcss.js') }}"></script> --}}
